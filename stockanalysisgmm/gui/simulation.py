...
class GmmSim(QThread):
    ...
    def init_model(self):
        ...
        gmm_candle_chart = GmmCandleChart(stock_ticker=STOCK_TICKER, candles=candle_objs)
    ...
    def run(self):
        ...
        for candle in self.sim_generator:
            ...
            ohlc_tup = (candle.open, candle.high, candle.low, candle.close, candle.label,candle.timestamp())
