...
from .sim_page import ChartPage, SimPage 
...
class MainWindow(QtWidgets.QWidget):
    def __init__(self):
        ...
        #self.sim_page = SimPage()
        self.chart_page = ChartPage()
        self.central_frame.addWidget(self.chart_page)
    ...
    def updateGrips(self):
        out_rect = self.rect()
        inRect = out_rect.adjusted(self.gripSize, self.gripSize, -self.gripSize, -self.gripSize)
        width = self.width()
        height = self.height()
        ...
        self.corner_grips[0].setGeometry(inRect.right(),inRect.bottom(), self.gripSize, self.gripSize)
        self.corner_grips[1].setGeometry(out_rect.left(), inRect.bottom(), self.gripSize, self.gripSize)
        self.corner_grips[2].setGeometry(inRect.right(), out_rect.top(), self.gripSize, self.gripSize)
        self.corner_grips[3].setGeometry(out_rect.left(), out_rect.top(), self.gripSize, self.gripSize)
